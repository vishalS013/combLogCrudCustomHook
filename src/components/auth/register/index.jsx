                ...
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl bg-slate-50 ">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            disabled={isRegistering}
                            className={`w-full px-4 py-2 text-white font-semibold rounded-lg ${isRegistering ? 'bg-gray-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 hover:shadow-xl transition duration-300'}`}
                        >
